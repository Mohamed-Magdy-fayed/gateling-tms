...
| 8. Sessions generated from the weekly schedule (now also asserted by the full-journey e2e — if the card offers "Regenerate" over an empty list, the queue is the problem, not the schedule) | ☐ |
