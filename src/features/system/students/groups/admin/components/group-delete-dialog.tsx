...
export function GroupDeleteDialog({
  ...
  const deleteMut = useMutation(trpc.groups.delete.mutationOptions());
  ...
  async function handleConfirm() {
    ...
    try {
      await toast
        .promise(deleteMut.mutateAsync({ id: group.id }), {
    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {group ? t("groups.deleteDescription", { name: group.name }) : ""}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
