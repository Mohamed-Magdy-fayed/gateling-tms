...
import { dataTableConfig } from "@/features/data-table/config/data-table";
        ...
        >
          <div className="flex flex-col gap-1">
            <h4 id={labelId} className="font-medium leading-none">
              {sorting.length > 0 ? t("dataTable.sortBy") : t("dataTable.noSorting")}
            </h4>
            <p
              id={descriptionId}
              className={cn(
            ...
            >
              {sorting.length > 0
                ? t("dataTable.modifySorting" as any)
                : t("dataTable.addSorting" as any)}
            </p>
          </div>
          {sorting.length > 0 && (
          ...
          <div className="flex w-full items-center gap-2">
            ...
            {sorting.length > 0 && (
              ...
              >
                {t("dataTable.resetSorting" as any)}
              </Button>
            )}
          </div>
        </PopoverContent>
    ...
    <SortableItem value={sort.id} asChild>
      ...
      >
        <Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
          ...
          >
            <Command>
              <CommandInput placeholder={useTranslation().t("dataTable.searchFields" as any)} />
              <CommandList>
                <CommandEmpty>{useTranslation().t("dataTable.noFieldsFound" as any)}</CommandEmpty>
                <CommandGroup>
                  {columns.map((column) => (
                    <CommandItem
                      key={column.id}
