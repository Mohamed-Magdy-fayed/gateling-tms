                        ...
                        <form className="p-6 md:p-8" onSubmit={form.handleSubmit(onSubmit)} >
                            <div className="flex flex-col gap-6">
                                <div className="flex flex-col items-center text-center">
                                    <h1 className="text-2xl font-bold">{t("auth.signin.subtitle")}</h1>
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    <Button variant="ghost" type="button" className="w-full !bg-stone-950">
                                    ...
                                    <Button variant="ghost" type="button" className="w-full !bg-red-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                            <path
                                    ...
                                    <Button variant="ghost" type="button" className="w-full !bg-blue-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                            <path
